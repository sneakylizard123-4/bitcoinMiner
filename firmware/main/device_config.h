...
static const FamilyConfig FAMILY_BITCOINMINER = { .id = BITCOINMINER, .name = "BitcoinMiner", .asic = ASIC_BM1370, .asic_count = 1, .max_power = 40, .power_offset = 5, .nominal_voltage = 5, .voltage_domains = 1, .swarm_color = "green", .tps546_config = &TPS546_CONFIG_DEFAULT, };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "bitcoinMiner", .family = FAMILY_BITCOINMINER, .pins = BITCOINMINER_PINS, .EMC2101 = true, .emc_ideality_factor = 0x24, .emc_beta_compensation = 0x00, .TPS546 = true, .power_consumption_target = 22, },
};
